 $(function() {
    	var table = $("#example").DataTable({
    		...
    		"ajax": {
                    "type": "POST",
                    "url":"/jiraResult/detailList?ftype=3",
                    "data":function(d){
...
//	    				    	
    					...
    					"mData" : "priority",
    					"orderable" : false, // 禁用排序  优先级
    					"sDefaultContent" : "",
    					"sWidth" : "2%",
    					
    				} ,  {
    					"mData" : "issue_title",
    					"orderable" : false, // 禁用排序 bug主题
    					"sDefaultContent" : "",
    					"sWidth" : "10%"
    				}
    				 ,  {
     					"mData" : "result",
     					"orderable" : false, // 禁用排序   状态
     					"sDefaultContent" : "",
     					"sWidth" : "10%"
     				}
    				, {
    					"mData" : "stop_time",
    					"orderable" : false, // 禁用排序 停留至今
    					"sDefaultContent" : "",
    					"sWidth" : "10%"
    				}
